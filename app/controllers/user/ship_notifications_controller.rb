class User::ShipNotificationsController < ApplicationController
  ...
  def send_shipping_notification(recipient, tracking_number, shipping_service, additional_notes, sender_email, sender_name, shipping_reciept, shipping_receipt_name, shipping_reciept_two, shipping_receipt_name_two, sender_company)
